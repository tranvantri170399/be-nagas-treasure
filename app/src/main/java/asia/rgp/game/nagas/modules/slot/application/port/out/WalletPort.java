...
/**
 * [PORT OUT] Interface for communicating with the external Wallet Service.
 * Ensures the Slot module remains decoupled from specific communication protocols (gRPC/REST).
 */
