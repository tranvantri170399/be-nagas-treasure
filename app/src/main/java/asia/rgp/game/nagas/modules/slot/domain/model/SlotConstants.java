...
public class SlotConstants {
  ...
  public static final String MODE_HOLD_AND_WIN = "hold_and_win";

  public static final String FEATURE_FREE_SPINS = "free_spins";
  public static final String FEATURE_HOLD_AND_WIN = "hold_and_win";
  public static final String FEATURE_JACKPOT = "progressive_jackpot";
