...
/**
 * Standard error constants for API error responses.
 * Only keeps the error **codes** as String constants to keep things simple.
 *
 * Example usage:
 * - ErrorConstant.DOMAIN_ERROR
...
public final class ErrorConstant {
    ...
    // 422 Unprocessable Content – request is syntactically correct but semantically invalid (validation)
