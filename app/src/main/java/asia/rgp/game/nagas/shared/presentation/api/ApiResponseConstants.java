...
/**
 * Constants for API response codes and descriptions.
 * Reusable across all REST controllers to avoid hardcoding.
 * 
 * These constants can be used for:
 * - Swagger/OpenAPI annotations (@ApiResponse)
 * - HTTP status codes in ResponseEntity
