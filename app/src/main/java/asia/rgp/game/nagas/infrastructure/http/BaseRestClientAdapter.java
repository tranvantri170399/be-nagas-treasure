...
/**
 * Abstract base class for REST API client adapters.
 * Provides common HTTP operations and utilities for implementing REST API
 * adapters.
 */
@Slf4j
public abstract class BaseRestClientAdapter {
     ...
     */
    protected BaseRestClientAdapter(
    ...
    protected <T, R> R executeGetRequest(
        ...
        return executeGetRequest(url, responseType, responseMapper, operationName, errorCode, unavailableCode, null);
    }
    ...
    protected <TRequest, TResponse, R> R executePostRequest(
            ...
            ErrorCode errorCode,
            ErrorCode unavailableCode) {
        return executePostRequest(url, request, responseType, responseMapper, operationName, errorCode, unavailableCode, null);
    }
